  ...
  return (
    <div className="relative" ref={container}>
      <div className="flex flex-col justify-center items-center gap-4 pt-6">
        <h1
          className="hero__heading opacity-0 text-balance text-center text-5xl font-medium md:text-6xl max-w-5xl pt-14"
        ...
        >
          ...
          sites web de l&apos;île de la Réunion.
        </h1>
        <p className="hero__body opacity-0 italic text-xs sm:text-lg">
          Site vitrine, e-commerce ou sur-mesure{" "}
          <span className="bg-gradient-to-b from-yellow-100 to-yellow-500 bg-clip-text not-italic text-transparent font-bold">
            gratuit
          </span>{" "}
          avec l&apos;aide régionale
        </p>
      ...
      <div>
        ...
        <p className="pt-11 text-center text-gray-400 text-xl italic">
          &quot;L&apos;Excellence Digitale à portée de clic&quot;
        </p>
      </div>
    </div>
  );
